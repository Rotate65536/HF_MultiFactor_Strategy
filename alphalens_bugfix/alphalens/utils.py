...
def compute_forward_returns(factor,
    ...
    prices : pd.DataFrame
        ...
        span the factor analysis time period plus an additional buffer x_window
...
def demean_forward_returns(factor_data, grouper=None):
    ...
    factor_data : pd.DataFrame - MultiIndex
        ...
        Separate column for each forward return x_window.
    grouper : list
...
def get_clean_factor_and_forward_returns(factor,
    ...
    prices : pd.DataFrame
        ...
        additional buffer x_window that is greater than the maximum number
